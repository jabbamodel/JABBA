...
$$
RMSE = 100\times\sqrt{\frac{\sum_{t=1}^{N}(Y_t-\hat{Y}_t)^2}{N}}
$$

where $Y_t$ is the observed CPUE in year t on the log scale, $\hat{Y}_t$ is the predicted CPUE in year $t$, and $N$ is the number of CPUE observations.
...
knitr::include_graphics('C:\\Users\\Maia.Kapur\\Downloads\\MS_JABBA_R1codes\\SWO_SA\\Scenario3_Pella\\Output\\Residuals_SWO_SA_Scenario3.png')
```